...
class ChromaDBAdapter(DocumentStorePort):
    ...
    def delete_document(self, document_id: str) -> bool:
        ...
        """
        try:
            existing = self._vector_store._collection.get(ids=[document_id], limit=1)
    ...
    def close(self) -> None:
        """Libera recursos de ChromaDB. El cliente PersistentClient no requiere close explícito."""
        pass
